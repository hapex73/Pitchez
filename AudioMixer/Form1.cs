...
namespace AudioMerger
{
    public partial class Form1 : Form
    {
        ...
        public void SetStatusLabel1Text(String pText)
        {
            StatusLabel1.Text = pText;
        }
        ...
        /// <summary>
        /// Event function for when the user selects the "About" option from the
        /// Help menu.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void HelpAboutMenuItem_Click(object sender, EventArgs e)
        {
            MessageBox.Show(this,
                            "Audio File Mixer\nCopyright \u00A9 2009 by Eric Oulashin",
                            "About Audio File Mixer",
